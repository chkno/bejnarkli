...
pkgs.haskellPackages.callPackage ({ base64-bytestring, cryptonite, errors
  , hindent, hlint, lib, memory, mkDerivation, nixfmt, QuickCheck
  , quickcheck-instances, stdenv, temporary, test-framework
  ...
  mkDerivation {
    ...
    libraryHaskellDepends =
      [ base64-bytestring cryptonite errors memory temporary utf8-string ];
    testHaskellDepends = [
      QuickCheck
